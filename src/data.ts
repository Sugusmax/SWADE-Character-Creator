...
export const SPECIES: Species[] = [
  ...
  { 
    ...
    abilities: [
      { id: 'ability-acuatico', name: 'Acuático', description: 'Los acuarianos no se ahogan en el agua y pueden moverse a su Paso completo cuando nadan.' },
  ...
  { 
    ...
    abilities: [
      ...
      { id: 'ability-garras-mordisco', name: 'Garras/Mordisco', description: 'Los colmillos y garras de los rakhasas se consideran Armas naturales y causan con ellos FUE+d4.' },
      ...
      { id: 'ability-sanguinario-rakhasa', name: 'Sanguinario', description: 'Los rakhasas pueden ser muy crueles con sus enemigos y, por tanto, todos reciben la desventaja Sanguinario. Rara vez toman prisioneros y sienten muy pocos remordimientos por ejecutarlos.' },
  ...
  { 
    ...
    abilities: [
      ...
      { id: 'ability-mordisco-saurio', name: 'Mordisco', description: 'El mordisco de un saurio causa FUE+d4 de daño y se considera un arma natural.' },
...
export const POWERS: Power[] = [
  { id: 'power-adivinacion', name: 'Adivinación', rank: 'Experimentado', points: '5', range: 'Personal', duration: '5 min.', description: 'Contactas con entidades.' },
  { id: 'power-alivio', name: 'Alivio', rank: 'Novato', points: '1', range: 'Astucia', duration: 'Instantánea', description: 'Recupera efectos y alivia penalizaciones.' },
  { id: 'power-amistad-animal', name: 'Amistad animal', rank: 'Novato', points: 'Especial', range: 'Astucia', duration: '10 min', description: 'Controlas animales.' },
  { id: 'power-aura-danina', name: 'Aura dañina', rank: 'Experimentado', points: '4', range: 'Astucia', duration: '5', description: 'Crea un aura que hace 2d4 de daño.' },
  { id: 'power-barrera', name: 'Barrera', rank: 'Experimentado', points: '2', range: 'Astucia', duration: '5', description: 'Crea un muro de 10x2 m, con Consistencia 10.' },
  { id: 'power-cambio-de-forma', name: 'Cambio de forma', rank: 'Novato', points: 'Especial', range: 'Personal', duration: '5', description: 'Adoptas la forma de otros seres.' },
  { id: 'power-captura', name: 'Captura', rank: 'Novato', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'Aferra o inmoviliza a las víctimas.' },
  { id: 'power-castigo', name: 'Castigo', rank: 'Novato', points: '2', range: 'Astucia', duration: '5', description: 'Aumenta +2/+4 el daño de un arma.' },
  { id: 'power-cavar', name: 'Cavar', rank: 'Novato', points: '2', range: 'Astucia', duration: '5', description: 'Te mueves bajo la tierra.' },
  { id: 'power-ceguera', name: 'Ceguera', rank: 'Novato', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'Penalización -2/-4 a las víctimas.' },
  { id: 'power-chorro', name: 'Chorro', rank: 'Novato', points: '2', range: 'Cono', duration: 'Instantánea', description: 'Ataque en área cónica por 2d6 de daño.' },
  { id: 'power-confusion', name: 'Confusión', rank: 'Novato', points: '1', range: 'Astucia', duration: 'Instantánea', description: 'Deja al objetivo distraído y vulnerable.' },
  { id: 'power-conmocion', name: 'Conmoción', rank: 'Novato', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'El objetivo queda conmocionado.' },
  { id: 'power-curacion', name: 'Curación', rank: 'Novato', points: '3', range: 'Toque', duration: 'Instantánea', description: 'Cura 1/2 heridas, veneno o enfermedad.' },
  { id: 'power-destierro', name: 'Destierro', rank: 'Veterano', points: '3', range: 'Astucia', duration: 'Instantánea', description: 'Espíritu opuesto para desterrar entidades.' },
  { id: 'power-desvio', name: 'Desvío', rank: 'Novato', points: '2', range: 'Astucia', duration: '5', description: '-2 a atacar al objetivo C/C o a distancia.' },
  { id: 'power-detectar-ocultar-arcano', name: 'Detectar/Ocultar Arcano', rank: 'Novato', points: '2', range: 'Astucia', duration: 'Especial', description: 'Detecta magia durante 5 rondas o la oculta durante 1 hora.' },
  { id: 'power-disfraz', name: 'Disfraz', rank: 'Experimentado', points: '2', range: 'Astucia', duration: '10 min.', description: 'El personaje parece otra persona.' },
  { id: 'power-disipacion', name: 'Disipación', rank: 'Novato', points: '1', range: 'Astucia', duration: 'Instantánea', description: 'Cancela un efecto mágico.' },
  { id: 'power-drenaje-de-pp', name: 'Drenaje de PP', rank: 'Veterano', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'Drenas 1d6 PP con tirada opuesta.' },
  { id: 'power-empatia', name: 'Empatía', rank: 'Novato', points: '1', range: 'Astucia', duration: '5', description: 'Tirada opuesta para añadir +2 a ataques sociales.' },
  { id: 'power-empujon', name: 'Empujón', rank: 'Novato', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'Los objetivos quedan distraídos y pueden salir volando.' },
  { id: 'power-explosion', name: 'Explosión', rank: 'Experimentado', points: '3', range: 'Astucia x2', duration: 'Instantánea', description: '2d6 daño en una PAM.' },
  { id: 'power-gigantismo-enanismo', name: "Gigantismo/\nEnanismo", rank: 'Experimentado', points: 'Especial', range: 'Astucia', duration: '5', description: 'Aumentas o reduces el Tamaño.' },
  { id: 'power-ilusion', name: 'Ilusión', rank: 'Novato', points: '3', range: 'Astucia', duration: '5', description: 'Crea imágenes ilusorias.' },
  { id: 'power-intangibilidad', name: 'Intangibilidad', rank: 'Veterano', points: '5', range: 'Astucia', duration: '5', description: 'El objetivo se hace incorpóreo.' },
  { id: 'power-invisibilidad', name: 'Invisibilidad', rank: 'Experimentado', points: '5', range: 'Astucia', duration: '5', description: 'El blanco es invisible (-4 o -6 para afectarle).' },
  { id: 'power-invocacion-de-aliados', name: 'Invocación de aliados', rank: 'Novato', points: 'Especial', range: 'Astucia', duration: '5', description: 'Conjuras un aliado de la nada.' },
  { id: 'power-lectura-de-mentes', name: 'Lectura de mentes', rank: 'Novato', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'Tirada opuesta contra Astucia para leer una mente.' },
  { id: 'power-lectura-de-objetos', name: 'Lectura de objetos', rank: 'Experimentado', points: '2', range: 'Toque', duration: 'Instantánea', description: 'Revela los últimos 5/100 años de la historia de un objeto.' },
  { id: 'power-lenguas', name: 'Lenguas', rank: 'Novato', points: '1', range: 'Astucia', duration: '10 min.', description: 'Hablas y comprendes un idioma.' },
  { id: 'power-lentitud-rapidez', name: 'Lentitud/Rapidez', rank: 'Experimentado', points: '2', range: 'Astucia', duration: 'Instantánea/5', description: 'Aumenta o reduce el movimiento.' },
  { id: 'power-luz-oscuridad', name: 'Luz/Oscuridad', rank: 'Novato', points: '2', range: 'Astucia', duration: '10 min.', description: 'Ilumina u oscurece una PAG.' },
  { id: 'power-manipulacion-de-recuerdos', name: 'Manip. de recuerdos', rank: 'Veterano', points: '3', range: 'Astucia', duration: 'Instantánea', description: 'Altera y elimina recuerdos.' },
  { id: 'power-manipulacion-elemental', name: 'Manip. elemental', rank: 'Novato', points: '1', range: 'Astucia', duration: '5', description: 'Permite manipulación básica de los elementos clásicos.' },
  { id: 'power-marioneta', name: 'Marioneta', rank: 'Veterano', points: '3', range: 'Astucia', duration: '5', description: 'Tirada opuesta contra Espíritu para controlar al objetivo.' },
  { id: 'power-mejora-reduccion-de-rasgo', name: 'Mej./Red. de rasgo', rank: 'Novato', points: '3', range: 'Astucia', duration: '5/Inst.', description: 'Aumenta o reduce una habilidad o atributo.' },
  { id: 'power-miedo', name: 'Miedo', rank: 'Novato', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'Provoca una tirada de miedo.' },
  { id: 'power-proteccion', name: 'Protección', rank: 'Novato', points: '1', range: 'Astucia', duration: '5', description: 'Otorga Armadura +2 (o Dureza).' },
  { id: 'power-proteccion-arcana', name: 'Protección arcana', rank: 'Novato', points: '1', range: 'Astucia', duration: '5', description: 'Resta -2 (-4 con aumento) al uso de poder contra objetivo; reduce daño en esa cantidad.' },
  { id: 'power-proteccion-ambiental', name: 'Prot. ambiental', rank: 'Novato', points: '2', range: 'Astucia', duration: '1 hora', description: 'Protege al objetivo de un entorno peligroso.' },
  { id: 'power-proyectil', name: 'Proyectil', rank: 'Novato', points: '1', range: 'Astucia x2', duration: 'Instantánea', description: 'Ataque a distancia por 2d6 de daño.' },
  { id: 'power-resurreccion', name: 'Resurrección', rank: 'Heroico', points: '30', range: 'Toque', duration: 'Instantánea', description: 'Devuelve la vida a una persona.' },
  { id: 'power-silencio-sonido', name: 'Silencio/Sonido', rank: 'Novato', points: '1', range: 'Especial', duration: '5/Inst.', description: 'Crea o apaga el sonido.' },
  { id: 'power-sueno', name: 'Sueño', rank: 'Experimentado', points: '2', range: 'Astucia', duration: '1 hora', description: 'Hace dormir a las víctimas.' },
  { id: 'power-telequinesis', name: 'Telequinesis', rank: 'Experimentado', points: '5', range: 'Astucia x2', duration: '5', description: 'Mueves objetos con Fuerza d10/d12.' },
  { id: 'power-teleportacion', name: 'Teleportación', rank: 'Experimentado', points: '2', range: 'Astucia', duration: 'Instantánea', description: 'Teleportas objetivo 12/24 pasos.' },
  { id: 'power-trepamuros', name: 'Trepamuros', rank: 'Novato', points: '2', range: 'Astucia', duration: '5', description: 'Mueves por muros a medio/entero Paso.' },
  { id: 'power-ventaja-de-combate', name: 'Ventaja de combate', rank: 'Experimentado', points: '4', range: 'Astucia', duration: '5', description: 'Ganas una ventaja de combate.' },
  { id: 'power-vinculo-mental', name: 'Vínculo mental', rank: 'Novato', points: '1', range: 'Astucia', duration: '30 min.', description: 'Telepatía a 1,5/8 kilómetros.' },
  { id: 'power-vision-oscura', name: 'Visión oscura', rank: 'Novato', points: '1', range: 'Astucia', duration: '1 hora', description: 'Reduce/Ignora penalizaciones por iluminación.' },
  { id: 'power-vista-lejana', name: 'Vista lejana', rank: 'Experimentado', points: '2', range: 'Astucia', duration: '5', description: 'Permite ver detalles a gran distancia; reduce/anula penalizaciones por distancia.' },
  { id: 'power-vuelo', name: 'Vuelo', rank: 'Veterano', points: '3', range: 'Astucia', duration: '5', description: 'Paso 12/24 volando.' },
  { id: 'power-zombi', name: 'Zombi', rank: 'Veterano', points: '3', range: 'Astucia', duration: '1 hora', description: 'Creas y controlas muertos vivientes.' },
];
