...
export const SKILLS: Omit<Skill, 'value'>[] = [
  { name: 'Apostar', attribute: 'Astucia', isBasic: false },
  { name: 'Atletismo', attribute: 'Agilidad', isBasic: true },
  { name: 'Cabalgar', attribute: 'Agilidad', isBasic: false },
  { name: 'Ciencia Extraña', attribute: 'Astucia', isBasic: false },
  { name: 'Ciencias', attribute: 'Astucia', isBasic: false },
  { name: 'Conducir', attribute: 'Agilidad', isBasic: false },
  { name: 'Conocimientos Generales', attribute: 'Astucia', isBasic: true },
  { name: 'Control', attribute: 'Espíritu', isBasic: false },
  { name: 'Disparar', attribute: 'Agilidad', isBasic: false },
  { name: 'Electrónica', attribute: 'Astucia', isBasic: false },
  { name: 'Fe', attribute: 'Espíritu', isBasic: false },
  { name: 'Hechicería', attribute: 'Astucia', isBasic: false },
  { name: 'Humanidades', attribute: 'Astucia', isBasic: false },
  { name: 'Idioma', attribute: 'Astucia', isBasic: false },
  { name: 'Interpretar', attribute: 'Espíritu', isBasic: false },
  ...
  { name: 'Ordenadores', attribute: 'Astucia', isBasic: false },
  { name: 'Pelear', attribute: 'Agilidad', isBasic: false },
  { name: 'Persuadir', attribute: 'Espíritu', isBasic: true },
  { name: 'Pilotar', attribute: 'Agilidad', isBasic: false },
  { name: 'Provocar', attribute: 'Astucia', isBasic: false },
  { name: 'Psiónica', attribute: 'Astucia', isBasic: false },
  { name: 'Reparar', attribute: 'Astucia', isBasic: false },
  { name: 'Sigilo', attribute: 'Agilidad', isBasic: true },
  { name: 'Supervivencia', attribute: 'Astucia', isBasic: false },
  { name: 'Tácticas', attribute: 'Astucia', isBasic: false },
];
